        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0, field_errors = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "checkFileName":
                        errorMsg = methods._checkFileName(field, rules, i, options);
                        break;
		...
		*/
        ...
        _checkFileType: function (field, rules, i, options) {
            ...
            if (uploadedFile) {
                ...
                else if (!reg.test($("#dispute_attachment_attach").val().split('\\').pop())){
                    return options.allrules.checkFileName.alertText;
                }
                else if ($(field).val() != "" && field[0].files[0].size > file_size){
                    return options.allrules.checkFileSize.alertText;
                }                
            }
            else {
                return true;
